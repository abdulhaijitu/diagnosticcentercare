  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom TrustCare colors
        trust: {
          teal: "hsl(var(--trust-teal))",
          "teal-light": "hsl(var(--trust-teal-light))",
          "teal-dark": "hsl(var(--trust-teal-dark))",
        },
        healing: {
          mint: "hsl(var(--healing-mint))",
        },
        care: {
          amber: "hsl(var(--care-amber))",
          "amber-light": "hsl(var(--care-amber-light))",
        },
        medical: {
