          ...
          <div className="bg-card rounded-3xl p-8 md:p-10 shadow-card border border-border">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Schedule your visit online</p>
              </div>
            </div>
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Choose from our wide range of diagnostic tests or book a consultation 
              with our specialist doctors. Easy online booking with flexible time slots.
            </p>
          ...
          <div className="bg-gradient-to-br from-primary to-trust-teal-light rounded-3xl p-8 md:p-10 text-primary-foreground">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-primary-foreground/80">We're here to assist you</p>
              </div>
            </div>
            <p className="text-primary-foreground/80 mb-6 leading-relaxed">
              Have questions about our services or need assistance with booking? 
              Our friendly support team is available to help you 24/7.
            </p>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-start gap-3 text-primary-foreground/80">
                ...
                <span className="text-sm">
                  Plot-04, Block-F, Dhaka Uddan, Mohammadpur, Dhaka-1207
                </span>
              </div>
            </div>
